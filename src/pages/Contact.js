            ...
            <div className='bg-slate-100 dark:text-white dark:bg-slate-900'>
                <section className="">
                    <div className="py-4 px-4 mx-auto max-w-screen-xl text-center ">
                        ...
                        <p className="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">Here at PUCIT Help Desk we make communication faster, easier and open.</p>
  ...
  <div className="py-4 px-4 mx-auto max-w-screen-xl">
      ...
      <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          <div>
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Chat on Facebook</h3>
              <p className="text-gray-500 dark:text-gray-400">Primary option to contact PUCIT Help Desk is on Facebook. Inbox us on our <a href="https://facebook.com/pucithd" className="text-black dark:text-white" target="_blank" rel='noreferrer'>facebook page</a>.</p>
          </div>
          <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <p className="text-gray-500 dark:text-gray-400">PUCIT Help Desk is remote-first, community-driven organisation.</p>
          </div>
          <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Reach Us</h3>
              <p className="text-gray-500 dark:text-gray-400">We welcome creative initiative suggestion and other information via email at <a href='mailto:info@pucithelpdesk.com' className='text-black dark:text-white'>info@pucithelpdesk.com</a></p>
          </div>
      </div>
  </div>
</section>
