...
export default function Contact() {
    return (
        <>
            ...
            <div className='bg-slate-100 dark:text-white dark:bg-slate-900'>
                <section class="">
                    <div class="py-4 px-4 mx-auto max-w-screen-xl text-center ">
                        {/* <a href="#" class="inline-flex justify-between items-center py-1 px-1 pr-4 mb-7 text-sm text-gray-700 bg-gray-100 rounded-full dark:bg-gray-800 dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700" role="alert">
                            <span class="text-xs bg-slate-600 rounded-full text-white px-4 py-1.5 mr-3">New</span> <span class="text-sm font-medium">Flowbite is out! See what's new</span> 
                            <svg class="ml-2 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
                        </a> */}
                        <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">We are you, You are us.</h1>
                        <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">Here at PUCIT Help Desk we make communication faster, easier and open.</p>
  ...
  <div class="py-4 px-4 mx-auto max-w-screen-xl">
      ...
      <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          <div>
              ...
              <p class="text-gray-500 dark:text-gray-400">Primary option to contact PUCIT Help Desk is on Facebook. Inbox us on our <a href="https://facebook.com/pucithd" className="text-black dark:text-white" target="_blank" rel='noreferrer'>facebook page</a>.</p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <p class="text-gray-500 dark:text-gray-400">PUCIT Help Desk is remote-first, community-driven organisation.</p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <p class="text-gray-500 dark:text-gray-400">We welcome creative initiative suggestion and other information via email at <a href='mailto:info@pucithelpdesk.com' className='text-black dark:text-white'>info@pucithelpdesk.com</a></p>
          </div>
      </div>
  </div>
</section>
