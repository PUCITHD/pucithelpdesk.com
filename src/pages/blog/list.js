                ...
                <div className='container mx-auto p-4 min-h-[100vh]'>
                    <div className='columns-1'>
                        ...
                        <div key={(blog.slug).toString()}>
                            <Link to={`${blog.slug}`}>
                                <div class="my-4 flex flex-col items-center bg-white rounded-lg border shadow-md md:flex-row  hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                                    <div class="flex flex-col justify-between p-4 leading-normal">
                                        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{parse(blog.title)}</h5>
                                        <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">{parse(blog.excerpt)}</p>
                                        <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Written By: {parse(blog.author.name)}</p>
                                    </div>
                                </div>
                            </Link>
                        </div>
